              ...
              <Col lg="4" md="6">
                ...
                >
                  <div className="footer-contant">
                    ...
                    <p>
                    The word 'SARVAM' a Sanskrit word that stands for "Everything" or "Complete", represents to the totality of our strengths as a company Infrastructure,Extensive Product Range, Quality and undying passion to remain ahead of the times. 
                    </p>
                    ...
                    <div className="footer-contant">
                      <ul className="contact-list">
                        <li>
                          ...
                          L-11, SIDCO Industrial Estate, Villivakkam, Chennai- 600049, Tamil Nadu, India
                        </li>
                        <li>
                          <i className="fa fa-phone"></i>Call Us: 044 – 4555 3337 / 044 – 4555 2227
                        </li>
                        {/* <li>
